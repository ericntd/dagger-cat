...
class ChildFragment : Fragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        val appComponent = (mainActivity.application as MyApp).component
        val mainActivityModule = MainActivityComponent.MainActivityModule(mainActivity)
